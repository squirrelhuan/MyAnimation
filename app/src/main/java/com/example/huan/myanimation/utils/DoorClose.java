...
public class DoorClose extends Animator {
    ...
    public DoorClose(int partCount) {
        this.partCount = partCount;
    }
    ...
    public void reData(float value) {
        ...
        for (int i = 0; i < partCount; i++) {
            ...
            if(i%2==0) {
                ...
                dst[3] = src[3] + (1-mFactor) * cell_width/2;
                dst[4] = dst[2];
                dst[5] = src[5]- (1-mFactor) * cell_width/2;
            }else {
                dst[0] = src[0] + (1-mFactor) * cell_width;
                dst[1] = src[1] + (1-mFactor) * cell_width/2;
                dst[6] = dst[0];
                dst[7] = src[7] - (1-mFactor)*cell_width/2;
            }
            Log.i("cgq", "mFactor=" + (1-mFactor));
            for (int y = 0; y < 8; y++) {
