...
public  class VerticleBlinds extends Animator{
    ...
    public void setPartCount(int partCount) {
        cell_width = partCount!=0?height/partCount:1;
    ...
    public VerticleBlinds(int partCount) {
        this.partCount = partCount;
    }
    ...
    public void reData(float value) {
        ...
        for (int i = 0; i < partCount; i++) {
            ...
            dst = src.clone();
            dst[5] = src[5]-(1-mFactor)* cell_width;
