...
public class LadderLeftDown extends Animator {
    ...
    public LadderLeftDown(int partCount) {
        this.partCount = partCount;
    }
    ...
    public void reDraw(Canvas canvas) {
        ...
        path.moveTo((float) (-width*0.5),(float)(height*1.5));
        ...
        path.lineTo((float) (-width*0.5),(float)(height*1.5));
        //先将canvas保存
        canvas.save();
        //设置为在圆形区域内绘制
